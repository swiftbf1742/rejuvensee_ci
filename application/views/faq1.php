	...
	<div  id="home">
		<div class="container">
			<div class="banner-top">
				<div class="logo-left">
					<a href="index.php"><img src="images/logo.png" data-wow-delay=".5s" class="img-responsive  wow slideInLeft animated text-center"></a>
				</div>
        ...
        <div class="col-md-3 logo-right mt4 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".6s">
			...
			<div class="top-nav header wow fadeInDown animated" data-wow-delay=".5s" bottom:0;>
				...
				<ul class="nav1" style="position:relative;">
					<img src="images/right-leaf.png" class="left-leaf">
					<img src="images/patti.png" class="faq-leaf">
				...
				<div class="col-sm-3 col-md-3">
					<ul class="socials2">
						...
						<li>
							...
							<img src="images/email.png" class="img-responsive img-circle">
							<span>Gmail</span>
						</li></a>
						<li>
							<a  href="#">
							<img src="images/print1.png" class="img-responsive">
							<span>Print</span>
						</li></a>
					</ul>
				</div>
				<div class="com-sm-7 col-md-7">
					<h1>shjxshsj</h1>
				</div>
			</div>
			<div class="clearfix"> </div>
