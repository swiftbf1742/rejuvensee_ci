	...
	<div  id="home">
		<div class="banner-top">
				<div class="text-center">
					<a href="<?=base_url()?>"><img src="<?=base_url()?>assets/images/logo.png" data-wow-delay=".5s" class="img-responsive logo wow slideInLeft animated text-center"></a>
				</div>
			...
			<div class="top-nav wow navi fadeInDown animated" data-wow-delay=".5s">
				...
				<ul class="nav1" style="position:relative;">
					...
					<img src="<?=base_url()?>assets/images/patti.png" class="banner-leaf">
			...
			<!-- <div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12">
					   ...
					   <h3>Everyday can herald a life of renewed vigor,vitility and verve,<br>An opportunity for you to reclaim what time and circumtances have taken away</h3>
		                <br><h2>A chance to breathe New Life</h2>
				</div>
			</div> -->
		   <ul class="rslides callbacks callbacks3" id="slider3">
		        <li id="callbacks3_s0" class="callbacks3_on" style="display: block; float: left; position: relative; background-image:url(http://casaestilo.in/rejuvensee_ci/assets/images/leaf_new.png); width: 100%; background-size: cover;">
				
		           <img src="" class="" alt="" style="width:100%;height:100vh;overflow:hidden;">
		           <div class="banner-text-info wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
		                <h3>Everyday can herald a life of renewed vigor,vitility and verve,<br>An opportunity for you to reclaim what time and circumtances have taken away</h3>
		                <br><h2>A chance to breathe New Life</h2>
		            </div>
		        </li>
