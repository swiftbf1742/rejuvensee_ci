        ...
        <div class="col-md-3 logo-right mt4 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".6s">
			...
			<div class="top-nav header wow fadeInDown animated" data-wow-delay=".5s">
				...
				<ul class="nav1" style="position:relative;">
					...
					<img src="<?=base_url()?>assets/images/patti.png" class="contact-leaf">
...
<div class="background">
	<div class="welcome container" id="welcome">
		<div class="about-banner">
			<img src="<?=base_url()?>assets/images/contact_s.png" class="img-responsive wow zoomIn" data-wow-duration="1s" data-wow-delay=".6s" width="100%;">
		</div>
		<div class="col-sm-4 col-md-4 col-xs-12"></div>
		<div class="col-md-6 col-sm-6 col-xs-12 text-left" style="margin-top:2%;"><h2 class="title">Contact us</h2></div>
		<div class="col-md-3 col-xs-3 wow slideInLeft" data-wow-duration="1s" data-wow-delay=".9s" style="margin-left: 4%; margin-top: 4%;">
			<ul class="socials2">
				<li>
		...
		<div class="col-md-8 col-xs-8 about wow slideInRight" data-wow-duration="1s" data-wow-delay=".10s" style="margin-top:-2.8% !important;">
			
		     <p><b>Meet us at:</b><br>
29-A, 1st Floor<br>Dr. Atmaram Rangnekar Marg<br>Opp. Anokhi, Off Hughes Road<br>
Girgaon Chowpatty<br>
Mumbai – 400007
<br><br>
<b>For consultations and appointments,<br>
reach us on:</b><br>
<b>T</b><a href="tel:+91 22 6655 5335/36" style="color: #000; text-decoration: none;"> +91 22 6655 5335/36</a><br>
<b>F</b><a href="tel:+91 22 23643109" style="color: #000; text-decoration: none;"> +91 22 23643109</a><br>
<b>E</b> <a href="mailto:corporate@sgel.in" style="color: #000; text-decoration: none;">contact@rejuvenesse.in</a></p>
